...
public class callVideoHandler extends Activity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener{

    MediaPlayer mPlayer;
    private String  TAG     = "VideoPlayerActivityTAG";
    private String   vidUrl  = "http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean auto = true;
        videoHandler = new VideoHandler(this, vidUrl, auto);
    }
