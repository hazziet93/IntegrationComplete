 ...
 * Notes:
 *
 *      In order for this class to work the layout xml file popup.xml must be included in the project.
 *      The animation xml files popup_hide and popup_show must also be included.
 *
 ...
 * Change History:
 * Version:0.1
 * Author: Andrew Perry & Carlos Archila
 ...
 * Change History:0.2
 * Author: Andrew Perry & Carlos Archila
 * Change: Refactored some methods
 * 3/3/15
 *
 *
 * Change History:0.3
...
public class AudioHandler implements MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener, AudioManager.OnAudioFocusChangeListener {
    ...
    private ImageButton playButton, muteButton;
    ...
    private void setPlaylist(ArrayList<String> songs){
    ...
    private void setupButtons(){
        popup = (ImageButton)  this.activity.findViewById(R.id.popup);
    }
